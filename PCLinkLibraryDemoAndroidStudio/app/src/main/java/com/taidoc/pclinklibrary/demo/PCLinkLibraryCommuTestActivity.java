...
public class PCLinkLibraryCommuTestActivity extends ListActivity {
                        ...
                        switch (clickItem) {
                            ...
                            case 3:
                                ...
                                if (record instanceof BloodGlucoseRecord) {
                                    ...
                                    databaseConn();
                                    test(sysValue,diaValue,pulseValue,ihbValue);
    ...
    private Connection databaseConn(){
        ...
        Log.d("DemoActivity", "start connect to database");
        try{
            Class.forName(driver);
            Log.d("DemoActivity","get the driver");
        }
    ...
    private void test(int sys, int dia, int pulse, int ihb){
        Statement st;
        //int sys=2;
        //int dia=2;
        //int pulse=1;
        ...
        { eee="world";}
        Log.d("Database try", "enter");
        if (connect !=null){
            Log.d("Database try","Connect not null");
            try{
                st=connect.createStatement();
                st.executeUpdate("INSERT INTO `yannan`(SYSTOLIC,DIASTOLIC,PULSE,IHB,yannan)"+
                        "VALUES("+sys+","+dia+","+pulse+","+ihb+",'"+eee+"')");
